...
$__scope_id = Lexical::init_closure("slim1", 144);
require_once("slim.php");
$app = new Slim();
Lexical::bind_lexing("slim1", 144, '$app', $app);
$n = 123;
Lexical::bind_lexing("slim1", 144, '$n', $n);
	$app->get("/books/:one/:two", "get_book")->name("get_book");
	function get_book($one, $two){
		$app =& Lexical::get_lexical_binding('slim1', 144, '$app', isset($__closure_id)?$__closure_id:0);;
		$n =& Lexical::get_lexical_binding('slim1', 144, '$n', isset($__closure_id)?$__closure_id:0);;
